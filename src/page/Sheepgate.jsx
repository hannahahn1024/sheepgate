...
const Sheepgate = () => {
  ...
  const [pastor2Text, setPastor2Text] = useState("양문교회 교회학교\n청년부 담당\n예수전도단 원주지부 간사")
    ...
    <div className='flex'>   
      <div className='w-40'>
        <Sidebar>
          ...
          <SidebarItem text="후원단체" path="support" scrollElement={scrollElement}/>
          <SidebarItem text="오시는 길" path="path" scrollElement={scrollElement}/>
        </Sidebar>
      </div>
      ...
      <div className='text-center whitespace-pre-line pb-10 pt-10 bg-slate-100 font-bold pointer-events-none border' id='church'> {welcomeText}</div>
        <div className='bg-slate-300 border' id='minister'>
          <div className='text-center text-4xl pb-10 font-bold pt-10'>섬기는 사람들</div>
        </div>
        <div className='bg-slate-100 border'>
          ...
          <div className= 'grid grid-cols-2 gap-12 pb-10'>
            ...
            <img src={Pastor} alt='Pastor Image' className='mx-auto w-1/2 border-4 border-slate-500'/>
          </div>
        </div>

        <div className='bg-slate-200 border'>
          <div className='text-center text-3xl pt-10 font-bold'>교육부 담임목사</div>
          <div className= 'grid grid-cols-2 gap-12 pb-10 pt-10'>
            <div>
              <img src={Pastor} alt='Pastor Image' className='w-2/6 mx-auto border-4 border-slate-500'/>
            </div>
        ...
        <div className='bg-slate-100 border'>
          ...
          <div className='grid grid-cols-4 pl-16 pb-10'>
            <div>
              ...
              <img src={jangro_4} alt='Elder Image 1' className='border-solid border-2 border-slate-300'/>
            </div>
            <div>
              <div className='font-bold text-lg'>김동환 장로</div>
              <img src={jangro_3} alt='Elder Image 2' className='border-solid border-2 border-slate-300'/>
            </div>
            <div>
              <div className='font-bold text-lg'>권태영 안수집사</div>
              <img src = {jangro_2} alt='Ordained deacon Image 1' className='border-solid border-2 border-slate-300'/>
            </div>
            <div>
              <div className='font-bold text-lg'>김상준 안수집사</div>
              <img src={jangro_1} alt='Ordained deacon Image 2' className='border-solid border-2 border-slate-300'/>
            </div>
          </div>
        </div>
        ...
        <div className='bg-slate-200 border text-center pb-10' id='support'>
          ...
          <div className='grid grid-cols-3'>
            <div className='ml-10'>
              ...
              <img src={cbs_logo} alt='cbs logo' className='flex mx-auto border-4 border-slate-500 rounded'/>

              <button onClick={() => window.open("https://www.cbs.co.kr/", "_blank")} className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow mt-3">
                더 알아보기
              </button>
            </div>
            <div>
              <div className='mb-2 font-bold text-lg'>한국 AWANA</div>
              <img src={awana_logo} alt='awana logo' className='flex mx-auto border-4 border-slate-600 rounded'/>
              <button onClick={() => window.open("http://www.awanakorea.net/", "_blank")} className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow mt-3">
                더 알아보기
              </button>
            </div>
            <div>
              ...
              <div>
                ...
                <img src={wonjuhospital} alt='wonjuhospital' className='flex mx-auto border-4 border-slate-500 rounded'/>
                  <button onClick={() => window.open("https://www.ywmc.or.kr/web/www", "_blank")} className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow mt-3">
                    더 알아보기
                  </button>
              </div>
            </div>
        ...
        <div className='bg-slate-100 border'>
          <div className='text-center text-3xl mb-10 pt-10 font-bold' id='path'>오시는 길</div>
        </div>
      </div>
